...
torchrun --nproc_per_node=8 train_grpo.py --model_path ../Downloads/Models/Qwen/Qwen2.5-VL-3B-Instruct --loss_type grpo    --output_dir output_grpo_qwen3_2b_thk  > qwen3vl2b-thk-grpo.out  
torchrun --nproc_per_node=8 train_grpo.py --model_path ../Downloads/Models/Qwen/Qwen2.5-VL-3B-Instruct --loss_type dr_grpo --output_dir output_grpo_qwen3_2b_thk  > qwen3vl2b-thk-dr_grpo.out 
torchrun --nproc_per_node=8 train_grpo.py --model_path ../Downloads/Models/Qwen/Qwen2.5-VL-3B-Instruct --loss_type dapo    --output_dir output_grpo_qwen3_2b_thk  > qwen3vl2b-thk-dapo.out  